...
public class HtmlValidatorTest {
    ...
    public void test1(){
        ...
        Assert.assertEquals(expectedOutputToString("src/expected_output_for_test1.txt"),
                validatorOutputToString(validator));
    ...
    public void test2(){
        ...
        Assert.assertEquals(expectedOutputToString("src/expected_output_for_test2.txt"),
                validatorOutputToString(validator));
    }
    ...
    public void test3(){
        ...
        Assert.assertEquals(expectedOutputToString("src/expected_output_for_test3.txt"),
                validatorOutputToString(validator));
    }
    ...
    public void test4(){
        ...
        Assert.assertEquals(expectedOutputToString("src/expected_output_for_test4.txt"),
                validatorOutputToString(validator));
    }
    ...
    public void test5(){
        ...
        Assert.assertEquals(expectedOutputToString("src/expected_output_for_test5.txt"),
                validatorOutputToString(validator));
    ...
    public void test6(){
        ...
        Assert.assertEquals(expectedOutputToString("src/expected_output_for_test6.txt"),
                validatorOutputToString(validator));
    ...
    public void test7(){
        ...
        Assert.assertEquals(expectedOutputToString("src/expected_output_for_test7.txt"),
                validatorOutputToString(validator));
    ...
    public void test8(){
        ...
        Assert.assertEquals(expectedOutputToString("src/expected_output_for_test8.txt"),
                validatorOutputToString(validator));
    }
